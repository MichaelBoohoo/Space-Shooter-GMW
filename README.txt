...
Za³o¿enie
Masz ju¿ pobran¹ bibliotekê SFML na dysku (na dysku C:\SFML). Jeœli nie, musisz j¹ pobraæ ze strony sfml-dev.org (wersja Visual C++).
...
Kliknij tam, wybierz <Edytuj...> i wska¿ folder include z Twojego SFML (C:..\SFML\include). lub $(SolutionDir)SFML\include
...
Kliknij tam, wybierz <Edytuj...> i wska¿ folder lib z Twojego SFML (C:..\SFML\lib). lub $(SolutionDir)SFML\include (tylko trzba uwa¿aæ czy siê œcierzka wyznaczy³a poni¿ej)
